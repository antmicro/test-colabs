...
$bin?=@https://zephyr-dashboard.renode.io/uboot/17012e3068d047ad71460f039eeb0c3be63f82a0/starfive_visionfive2--starfive-jh7110-deepcomputing-fml13v01/uboot/uboot.elf
$repl?=$ORIGIN/uboot.repl

using sysbus
mach create $name

machine LoadPlatformDescription @https://u-boot-dashboard.renode.io/uboot_sim/17012e3068d047ad71460f039eeb0c3be63f82a0/620bf6ac483da090947d50639d6ea88e97c34f35/starfive_visionfive2--starfive-jh7110-deepcomputing-fml13v01/uboot/uboot.repl
...
"""
    ...
    cpu2 IsHalted true
    cpu3 IsHalted true
    sysbus LoadSymbolsFrom @https://zephyr-dashboard.renode.io/uboot/17012e3068d047ad71460f039eeb0c3be63f82a0/starfive_visionfive2--starfive-jh7110-deepcomputing-fml13v01/uboot/uboot.elf textAddress=0x00000000fff44000
    ...
    cpu0 SetRegister "A1" 0x0000000040287b10                # fdt location
...
machine = emulation.get_mach("starfive_visionfive2--starfive-jh7110-deepcomputing-fml13v01")
