...
$bin?=@https://zephyr-dashboard.renode.io/zephyr/6182bc08c9d72e9e9aed8f5cf05a406fbfd25dd8/qemu_x86_atom_nokpti/hello_world_user/hello_world_user.elf
$repl?=$ORIGIN/hello_world_user.repl

using sysbus
mach create $name

machine LoadPlatformDescription @https://zephyr-dashboard.renode.io/zephyr_sim/6182bc08c9d72e9e9aed8f5cf05a406fbfd25dd8/5e276e25c2c71e62f2427c7773ca4c09f9a6c330/qemu_x86_atom_nokpti/hello_world_user/hello_world_user.repl
...
terminalTester.WaitFor(String("Hello World from UserSpace! (qemu_x86_atom_nokpti)"), pauseEmulation=True)
