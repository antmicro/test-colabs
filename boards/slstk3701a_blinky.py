...
$name?="slstk3701a"
$bin?=@https://zephyr-dashboard.renode.io/zephyr/3deeffb422071c6320b601796cf98e761abd662a/slstk3701a/blinky/blinky.elf
$repl?=$ORIGIN/blinky.repl

using sysbus
mach create $name

machine LoadPlatformDescription @https://zephyr-dashboard.renode.io/zephyr_sim/3deeffb422071c6320b601796cf98e761abd662a/aadba26ac052f0e522abcb035a1b99315f49eda8/slstk3701a/blinky/blinky.repl
