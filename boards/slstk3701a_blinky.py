...
machine LoadPlatformDescription @https://zephyr-dashboard.renode.io/zephyr_sim/76e1fc7713a4a3f2b50c497afddec0364a34c10b/234e81a06ec4b68b8091b7a9e595f25a611c1ce5/slstk3701a/blinky/blinky.repl
machine EnableProfiler $ORIGIN/metrics.dump


showAnalyzer usart4

usart4 RecordToAsciinema $ORIGIN/blinky-asciinema
set osPanicHook
"""
...
macro reset
"""
    sysbus LoadELF @https://zephyr-dashboard.renode.io/zephyr/76e1fc7713a4a3f2b50c497afddec0364a34c10b/slstk3701a/blinky/blinky.elf
...
ledTester = LEDTester(emulation, machine.sysbus.gpioh.led0, "ledTester", 0)
