...
$bin?=@https://zephyr-dashboard.renode.io/uboot/365a7079fb918643da0f0709660a7d8ea76dd6f3/milkv_duo--cv1800b-milkv-duo/uboot/uboot.elf
$repl?=$ORIGIN/uboot.repl

using sysbus
mach create $name

machine LoadPlatformDescription @https://u-boot-dashboard.renode.io/uboot_sim/365a7079fb918643da0f0709660a7d8ea76dd6f3/d82be128f20e28a4954fe2bd70f980fdffe32609/milkv_duo--cv1800b-milkv-duo/uboot/uboot.repl
...
cpu0 InstallCustomInstructionHandlerFromString "00000001100100000000000000001011" "" # SYNC_S
    ...
    cpu0 SetRegister "A1" 0x0000000080251a20                # fdt location
