...
$name?="starfive_visionfive2--starfive-jh7110-starfive-visionfive-2-lite-emmc"
$bin?=@https://zephyr-dashboard.renode.io/uboot/527115ef6783cec49e5610c523c124b399011361/starfive_visionfive2--starfive-jh7110-starfive-visionfive-2-lite-emmc/uboot/uboot.elf
$repl?=$ORIGIN/uboot.repl

using sysbus
mach create $name

machine LoadPlatformDescription @https://u-boot-dashboard.renode.io/uboot_sim/527115ef6783cec49e5610c523c124b399011361/1a7a8b98a93b37b4537c0f7810cd17eb2bb55ae4/starfive_visionfive2--starfive-jh7110-starfive-visionfive-2-lite-emmc/uboot/uboot.repl
...
"""
    ...
    cpu0 SetRegister "A1" 0x00000000402a4760                # fdt location
...
machine = emulation.get_mach("starfive_visionfive2--starfive-jh7110-starfive-visionfive-2-lite-emmc")
