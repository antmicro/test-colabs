...
$bin?=@https://zephyr-dashboard.renode.io/uboot/b3f69c14187d413610abbc2b82d1a3752cb342c1/radxa-e25-rk3568--rockchip-rk3568-radxa-e25/uboot/uboot.elf
$repl?=$ORIGIN/uboot.repl

using sysbus
mach create $name

machine LoadPlatformDescription @https://u-boot-dashboard.renode.io/uboot_sim/b3f69c14187d413610abbc2b82d1a3752cb342c1/4f68d8d3ac0048d5a44ca2172cbf6ffb40837323/radxa-e25-rk3568--rockchip-rk3568-radxa-e25/uboot/uboot.repl
...
"""
    ...
    cpu2 IsHalted true
    cpu3 IsHalted true
    sysbus LoadSymbolsFrom @https://zephyr-dashboard.renode.io/uboot/b3f69c14187d413610abbc2b82d1a3752cb342c1/radxa-e25-rk3568--rockchip-rk3568-radxa-e25/uboot/uboot.elf textAddress=0x000000000ff2d000
