...
machine LoadPlatformDescription @https://zephyr-dashboard.renode.io/zephyr_sim/99adbadad5a2ccd70ed7e7a483b7615bd043d999/b672f64553038487a18982117c723859240f277e/mpfs_icicle/blinky/blinky.repl
...
macro reset
"""
    sysbus LoadELF @https://zephyr-dashboard.renode.io/zephyr/99adbadad5a2ccd70ed7e7a483b7615bd043d999/mpfs_icicle/blinky/blinky.elf
    cpu1 IsHalted true
    cpu2 IsHalted true
    cpu3 IsHalted true
    cpu4 IsHalted true
