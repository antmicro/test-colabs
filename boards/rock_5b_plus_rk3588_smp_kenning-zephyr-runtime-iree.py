...
[![Run in Google Colab](https://img.shields.io/badge/-Run%20in%20Google%20colab-%23007ded?logo=google-colab&logoColor=white&style=for-the-badge)](https://colab.research.google.com/github/antmicro/test-colabs/blob/main/boards/rock_5b_plus_rk3588_smp_kenning-zephyr-runtime-iree.ipynb) [![View ipynb](https://img.shields.io/badge/-View%20ipynb%20source-%23007ded?logo=jupyter&logoColor=white&style=for-the-badge)](https://github.com/antmicro/test-colabs/blob/main/boards/rock_5b_plus_rk3588_smp_kenning-zephyr-runtime-iree.ipynb) [![View Python source](https://img.shields.io/badge/-View%20Python%20source-%23007ded?logo=python&logoColor=white&style=for-the-badge)](https://github.com/antmicro/test-colabs/blob/main/boards/rock_5b_plus_rk3588_smp_kenning-zephyr-runtime-iree.py)
"""
...
$name?="rock_5b_plus_rk3588_smp"
$bin?=@https://zephyr-dashboard.renode.io/zephyr/c5dffcb7c9da611b40a828f79fc6a8405416c1ed/rock_5b_plus_rk3588_smp/kenning-zephyr-runtime-iree/kenning-zephyr-runtime-iree.elf
$repl?=$ORIGIN/kenning-zephyr-runtime-iree.repl

using sysbus
mach create $name

machine LoadPlatformDescription @https://zephyr-dashboard.renode.io/zephyr_sim/c5dffcb7c9da611b40a828f79fc6a8405416c1ed/ca819552dcd6627e19c44b25cfd1df9dbc17be42/rock_5b_plus_rk3588_smp/kenning-zephyr-runtime-iree/kenning-zephyr-runtime-iree.repl
...
uart2 RecordToAsciinema $ORIGIN/kenning-zephyr-runtime-iree-asciinema
set osPanicHook
"""
...
"""
    ...
    cpu4 PSCIEmulationMethod SMC
    cpu4 IsHalted true
    cpu4 EnableZephyrMode
    cpu5 PSCIEmulationMethod SMC
    cpu5 IsHalted true
    cpu5 EnableZephyrMode
    cpu6 PSCIEmulationMethod SMC
    cpu6 IsHalted true
    cpu6 EnableZephyrMode
    cpu7 PSCIEmulationMethod SMC
    cpu7 IsHalted true
    cpu7 EnableZephyrMode
"""
...
machine = emulation.get_mach("rock_5b_plus_rk3588_smp")
