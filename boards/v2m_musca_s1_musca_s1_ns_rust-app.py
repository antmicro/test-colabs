...
$bin?=@https://zephyr-dashboard.renode.io/zephyr/3deeffb422071c6320b601796cf98e761abd662a/v2m_musca_s1_musca_s1_ns/rust-app/rust-app.elf
$repl?=$ORIGIN/rust-app.repl

using sysbus
mach create $name

machine LoadPlatformDescription @https://zephyr-dashboard.renode.io/zephyr_sim/3deeffb422071c6320b601796cf98e761abd662a/aadba26ac052f0e522abcb035a1b99315f49eda8/v2m_musca_s1_musca_s1_ns/rust-app/rust-app.repl
