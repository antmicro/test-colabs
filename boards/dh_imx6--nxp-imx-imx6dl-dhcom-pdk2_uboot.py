...
$bin?=@https://zephyr-dashboard.renode.io/uboot/527115ef6783cec49e5610c523c124b399011361/dh_imx6--nxp-imx-imx6dl-dhcom-pdk2/uboot/uboot.elf
$repl?=$ORIGIN/uboot.repl

using sysbus
mach create $name

machine LoadPlatformDescription @https://u-boot-dashboard.renode.io/uboot_sim/527115ef6783cec49e5610c523c124b399011361/06854d4d1def596a9a88aa841030c600df2249d3/dh_imx6--nxp-imx-imx6dl-dhcom-pdk2/uboot/uboot.repl
...
"""
    ...
    cpu1 IsHalted true
    sysbus LoadBinary @https://zephyr-dashboard.renode.io/uboot/527115ef6783cec49e5610c523c124b399011361/dh_imx6--nxp-imx-imx6dl-dhcom-pdk2/uboot/uboot.dtb 0x178a6850
"""
