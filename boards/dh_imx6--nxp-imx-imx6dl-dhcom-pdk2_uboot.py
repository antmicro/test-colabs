...
$bin?=@https://zephyr-dashboard.renode.io/uboot/6073c36b2c8d39afe3ecc789b281667a3ddebc70/dh_imx6--nxp-imx-imx6dl-dhcom-pdk2/uboot/uboot.elf
$repl?=$ORIGIN/uboot.repl

using sysbus
mach create $name

machine LoadPlatformDescription @https://u-boot-dashboard.renode.io/uboot_sim/6073c36b2c8d39afe3ecc789b281667a3ddebc70/33e77808c5a2f861607beb9199d2e21e6aae4632/dh_imx6--nxp-imx-imx6dl-dhcom-pdk2/uboot/uboot.repl
...
"""
    ...
    cpu1 IsHalted true
    sysbus LoadBinary @https://zephyr-dashboard.renode.io/uboot/6073c36b2c8d39afe3ecc789b281667a3ddebc70/dh_imx6--nxp-imx-imx6dl-dhcom-pdk2/uboot/uboot.dtb 0x178a6860
"""
...
machine = emulation.get_mach("dh_imx6--nxp-imx-imx6dl-dhcom-pdk2")
