...
$name?="rm1xx_dvk"
$bin?=@https://zephyr-dashboard.renode.io/zephyr/497209c74ead38a01e9d0480b6551f8156939a7a/rm1xx_dvk/philosophers/philosophers.elf
$repl?=$ORIGIN/philosophers.repl

using sysbus
mach create $name

machine LoadPlatformDescription @https://zephyr-dashboard.renode.io/zephyr_sim/497209c74ead38a01e9d0480b6551f8156939a7a/acd4851c0c3b31478ba6877431be65844c5dfb77/rm1xx_dvk/philosophers/philosophers.repl
