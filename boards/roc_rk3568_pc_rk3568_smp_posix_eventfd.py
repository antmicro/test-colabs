...
$bin?=@https://zephyr-dashboard.renode.io/zephyr/17da549ce2acc13a7d9897eb4339604b3f3a54e8/roc_rk3568_pc_rk3568_smp/posix_eventfd/posix_eventfd.elf
$repl?=$ORIGIN/posix_eventfd.repl

using sysbus
mach create $name

machine LoadPlatformDescription @https://zephyr-dashboard.renode.io/zephyr_sim/17da549ce2acc13a7d9897eb4339604b3f3a54e8/f415d947c5e368042f920915fd0b5a2b5f185686/roc_rk3568_pc_rk3568_smp/posix_eventfd/posix_eventfd.repl
