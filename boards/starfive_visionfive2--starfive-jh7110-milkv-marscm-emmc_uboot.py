...
$bin?=@https://zephyr-dashboard.renode.io/uboot/eefb822fb574e28d49fc9f358328854e17fc8406/starfive_visionfive2--starfive-jh7110-milkv-marscm-emmc/uboot/uboot.elf
$repl?=$ORIGIN/uboot.repl

using sysbus
mach create $name

machine LoadPlatformDescription @https://u-boot-dashboard.renode.io/uboot_sim/eefb822fb574e28d49fc9f358328854e17fc8406/6f41c16b7aa0a8efe5c94f7f0964994c44845eb4/starfive_visionfive2--starfive-jh7110-milkv-marscm-emmc/uboot/uboot.repl
...
"""
    ...
    cpu0 SetRegister "A1" 0x00000000402a2250                # fdt location
