...
$name?="starfive_visionfive2--starfive-jh7110-milkv-marscm-emmc"
$bin?=@https://zephyr-dashboard.renode.io/uboot/c5e6d2ab7eba68cbfb600cdc131c0c375ced2ec9/starfive_visionfive2--starfive-jh7110-milkv-marscm-emmc/uboot/uboot.elf
$repl?=$ORIGIN/uboot.repl

using sysbus
mach create $name

machine LoadPlatformDescription @https://u-boot-dashboard.renode.io/uboot_sim/c5e6d2ab7eba68cbfb600cdc131c0c375ced2ec9/6c22cb92bc98d7a88feff30f0438e5c6fb9003af/starfive_visionfive2--starfive-jh7110-milkv-marscm-emmc/uboot/uboot.repl
...
"""
    ...
    cpu0 SetRegister "A1" 0x00000000402896a0                # fdt location
...
machine = emulation.get_mach("starfive_visionfive2--starfive-jh7110-milkv-marscm-emmc")
