...
machine LoadPlatformDescription @https://u-boot-dashboard.renode.io/uboot_sim/2ca1398a5ece8d33d8feb6b410e6e38588b5d2bc/327f86675b49497a02301a95de5220ccc7bab67d/xilinx_zynqmp_kria--zynqmp-smk-k26-reva/uboot/uboot.repl
...
macro reset
"""
    sysbus LoadELF @https://zephyr-dashboard.renode.io/uboot/2ca1398a5ece8d33d8feb6b410e6e38588b5d2bc/xilinx_zynqmp_kria--zynqmp-smk-k26-reva/uboot/uboot.elf
    cpu0 EnableUbootMode
    cpu0 EnableZephyrMode
    cpu1 IsHalted true
    cpu2 IsHalted true
    cpu3 IsHalted true
    sysbus LoadSymbolsFrom @https://zephyr-dashboard.renode.io/uboot/2ca1398a5ece8d33d8feb6b410e6e38588b5d2bc/xilinx_zynqmp_kria--zynqmp-smk-k26-reva/uboot/uboot.elf textAddress=0x000000007fdb9000
...
machine = emulation.get_mach("xilinx_zynqmp_kria--zynqmp-smk-k26-reva")
