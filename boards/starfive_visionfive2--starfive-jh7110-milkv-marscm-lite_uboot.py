...
$name?="starfive_visionfive2--starfive-jh7110-milkv-marscm-lite"
$bin?=@https://zephyr-dashboard.renode.io/uboot/62b45e82bdbf703571450e97f605893fe0d50530/starfive_visionfive2--starfive-jh7110-milkv-marscm-lite/uboot/uboot.elf
$repl?=$ORIGIN/uboot.repl

using sysbus
mach create $name

machine LoadPlatformDescription @https://u-boot-dashboard.renode.io/uboot_sim/62b45e82bdbf703571450e97f605893fe0d50530/acd4851c0c3b31478ba6877431be65844c5dfb77/starfive_visionfive2--starfive-jh7110-milkv-marscm-lite/uboot/uboot.repl
...
"""
    ...
    cpu0 SetRegister "A1" 0x00000000402897d0                # fdt location
...
machine = emulation.get_mach("starfive_visionfive2--starfive-jh7110-milkv-marscm-lite")
