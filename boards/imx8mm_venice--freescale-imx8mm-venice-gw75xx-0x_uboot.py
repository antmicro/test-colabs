...
$bin?=@https://zephyr-dashboard.renode.io/uboot/437ea9f8be5afaebe2d8cbab6242f1182857f21e/imx8mm_venice--freescale-imx8mm-venice-gw75xx-0x/uboot/uboot.elf
$repl?=$ORIGIN/uboot.repl

using sysbus
mach create $name

machine LoadPlatformDescription @https://u-boot-dashboard.renode.io/uboot_sim/437ea9f8be5afaebe2d8cbab6242f1182857f21e/f415d947c5e368042f920915fd0b5a2b5f185686/imx8mm_venice--freescale-imx8mm-venice-gw75xx-0x/uboot/uboot.repl
...
"""
    ...
    cpu2 IsHalted true
    cpu3 IsHalted true
    sysbus LoadBinary @https://zephyr-dashboard.renode.io/uboot/437ea9f8be5afaebe2d8cbab6242f1182857f21e/imx8mm_venice--freescale-imx8mm-venice-gw75xx-0x/uboot/uboot.dtb 0x0000000040300150
"""
