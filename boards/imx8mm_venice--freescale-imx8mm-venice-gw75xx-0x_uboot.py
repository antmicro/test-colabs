...
$bin?=@https://zephyr-dashboard.renode.io/uboot/780084d7c07f511da4a39b43277c573156ed42e0/imx8mm_venice--freescale-imx8mm-venice-gw75xx-0x/uboot/uboot.elf
$repl?=$ORIGIN/uboot.repl

using sysbus
mach create $name

machine LoadPlatformDescription @https://u-boot-dashboard.renode.io/uboot_sim/780084d7c07f511da4a39b43277c573156ed42e0/2f38330776ed8394dfffbd33bdbd858255ca7bdd/imx8mm_venice--freescale-imx8mm-venice-gw75xx-0x/uboot/uboot.repl
...
"""
    ...
    cpu2 IsHalted true
    cpu3 IsHalted true
    sysbus LoadBinary @https://zephyr-dashboard.renode.io/uboot/780084d7c07f511da4a39b43277c573156ed42e0/imx8mm_venice--freescale-imx8mm-venice-gw75xx-0x/uboot/uboot.dtb 0x0000000040301050
"""
