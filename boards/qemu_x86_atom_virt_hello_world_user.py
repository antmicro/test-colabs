...
$bin?=@https://zephyr-dashboard.renode.io/zephyr/b84319c460bfdf368ae26382928ec53c913752e6/qemu_x86_atom_virt/hello_world_user/hello_world_user.elf
$repl?=$ORIGIN/hello_world_user.repl

using sysbus
mach create $name

machine LoadPlatformDescription @https://zephyr-dashboard.renode.io/zephyr_sim/b84319c460bfdf368ae26382928ec53c913752e6/0c4e92ce0b6376983f8640ebc6fd9e34a3bb6f0e/qemu_x86_atom_virt/hello_world_user/hello_world_user.repl
...
terminalTester.WaitFor(String("Hello World from UserSpace! (qemu_x86_atom_virt)"), pauseEmulation=True)
