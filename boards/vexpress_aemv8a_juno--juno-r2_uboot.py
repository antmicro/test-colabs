...
machine LoadPlatformDescription @https://u-boot-dashboard.renode.io/vexpress_aemv8a_juno--juno-r2-uboot/vexpress_aemv8a_juno--juno-r2-uboot.repl
...
macro reset
"""
    sysbus LoadELF @https://u-boot-dashboard.renode.io/vexpress_aemv8a_juno--juno-r2-uboot/vexpress_aemv8a_juno--juno-r2-uboot.elf
    cpu1 IsHalted true
    cpu2 IsHalted true
    cpu3 IsHalted true
    cpu4 IsHalted true
