...
$bin?=@https://zephyr-dashboard.renode.io/zephyr/112871afa4f32da694164b668559b1108c96f5cc/opentitan_earlgrey/hello_world/hello_world.elf
$repl?=$ORIGIN/hello_world.repl

using sysbus
mach create $name

machine LoadPlatformDescription @https://zephyr-dashboard.renode.io/zephyr_sim/112871afa4f32da694164b668559b1108c96f5cc/e785419a6a543712a66b981fc36709a53c9f6a8f/opentitan_earlgrey/hello_world/hello_world.repl
...
terminalTester.WaitFor(String("Hello World! opentitan_earlgrey"), pauseEmulation=True)
