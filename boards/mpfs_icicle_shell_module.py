...
machine LoadPlatformDescription @https://zephyr-dashboard.renode.io/zephyr_sim/f9e3b65d3a9794ee2233aa88172346f887b48d04/1cfe00236a5b1483a5f4de2cf6fa5ca79cc05a7b/mpfs_icicle/shell_module/shell_module.repl
...
macro reset
"""
    sysbus LoadELF @https://zephyr-dashboard.renode.io/zephyr/f9e3b65d3a9794ee2233aa88172346f887b48d04/mpfs_icicle/shell_module/shell_module.elf
    cpu1 IsHalted true
    cpu2 IsHalted true
    cpu3 IsHalted true
    cpu4 IsHalted true
