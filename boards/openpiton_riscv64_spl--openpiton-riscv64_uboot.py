...
$bin?=@https://zephyr-dashboard.renode.io/uboot/527115ef6783cec49e5610c523c124b399011361/openpiton_riscv64_spl--openpiton-riscv64/uboot/uboot.elf
$repl?=$ORIGIN/uboot.repl

using sysbus
mach create $name

machine LoadPlatformDescription @https://u-boot-dashboard.renode.io/uboot_sim/527115ef6783cec49e5610c523c124b399011361/1a7a8b98a93b37b4537c0f7810cd17eb2bb55ae4/openpiton_riscv64_spl--openpiton-riscv64/uboot/uboot.repl
...
"""
    ...
    cpu0 SetRegister "A1" 0x00000000800316c0                # fdt location
