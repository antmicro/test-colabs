...
$bin?=@https://zephyr-dashboard.renode.io/uboot/ff498a3c5efb424accc1d825cc45cede2540ca13/openpiton_riscv64_spl--openpiton-riscv64/uboot/uboot.elf
$repl?=$ORIGIN/uboot.repl

using sysbus
mach create $name

machine LoadPlatformDescription @https://u-boot-dashboard.renode.io/uboot_sim/ff498a3c5efb424accc1d825cc45cede2540ca13/d228058428cec4d6b66916cf4133bcbab372011b/openpiton_riscv64_spl--openpiton-riscv64/uboot/uboot.repl
...
"""
    ...
    cpu0 SetRegister "A1" 0x00000000800313e0                # fdt location
