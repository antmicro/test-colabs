...
$bin?=@https://zephyr-dashboard.renode.io/uboot/6902fb4c17faa375003124c451c2550deab5463d/openpiton_riscv64_spl--openpiton-riscv64/uboot/uboot.elf
$repl?=$ORIGIN/uboot.repl

using sysbus
mach create $name

machine LoadPlatformDescription @https://u-boot-dashboard.renode.io/uboot_sim/6902fb4c17faa375003124c451c2550deab5463d/23b222d52d05f623d4056e3c7d9c9d8f27df0fc0/openpiton_riscv64_spl--openpiton-riscv64/uboot/uboot.repl
...
"""
    ...
    cpu0 SetRegister "A1" 0x0000000080031640                # fdt location
