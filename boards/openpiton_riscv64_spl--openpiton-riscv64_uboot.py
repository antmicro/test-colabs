...
$bin?=@https://zephyr-dashboard.renode.io/uboot/e3405917a1806971d9e72a94186b299f05581e1a/openpiton_riscv64_spl--openpiton-riscv64/uboot/uboot.elf
$repl?=$ORIGIN/uboot.repl

using sysbus
mach create $name

machine LoadPlatformDescription @https://u-boot-dashboard.renode.io/uboot_sim/e3405917a1806971d9e72a94186b299f05581e1a/f737da4d0af595b97dc46376762a8c876002c508/openpiton_riscv64_spl--openpiton-riscv64/uboot/uboot.repl
...
"""
    ...
    cpu0 SetRegister "A1" 0x0000000080031500                # fdt location
