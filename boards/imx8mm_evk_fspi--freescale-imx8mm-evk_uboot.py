...
$bin?=@https://zephyr-dashboard.renode.io/uboot/ff498a3c5efb424accc1d825cc45cede2540ca13/imx8mm_evk_fspi--freescale-imx8mm-evk/uboot/uboot.elf
$repl?=$ORIGIN/uboot.repl

using sysbus
mach create $name

machine LoadPlatformDescription @https://u-boot-dashboard.renode.io/uboot_sim/ff498a3c5efb424accc1d825cc45cede2540ca13/d228058428cec4d6b66916cf4133bcbab372011b/imx8mm_evk_fspi--freescale-imx8mm-evk/uboot/uboot.repl
...
"""
    ...
    cpu2 IsHalted true
    cpu3 IsHalted true
    sysbus LoadBinary @https://zephyr-dashboard.renode.io/uboot/ff498a3c5efb424accc1d825cc45cede2540ca13/imx8mm_evk_fspi--freescale-imx8mm-evk/uboot/uboot.dtb 0x00000000402baa60
"""
