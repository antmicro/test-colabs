...
machine LoadPlatformDescription @https://zephyr-dashboard.renode.io/zephyr_sim/76e1fc7713a4a3f2b50c497afddec0364a34c10b/234e81a06ec4b68b8091b7a9e595f25a611c1ce5/qemu_riscv32_qemu_virt_riscv32_smp/hello_world_user/hello_world_user.repl
...
macro reset
"""
    sysbus LoadELF @https://zephyr-dashboard.renode.io/zephyr/76e1fc7713a4a3f2b50c497afddec0364a34c10b/qemu_riscv32_qemu_virt_riscv32_smp/hello_world_user/hello_world_user.elf
...
terminalTester.WaitFor(String("Hello World from UserSpace! (qemu_riscv32_qemu_virt_riscv32_smp)"), pauseEmulation=True)
