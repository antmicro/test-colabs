...
$name?="sensortile_box"
$bin?=@https://zephyr-dashboard.renode.io/zephyr/769c4f2846db675bc5c584b6d35551ad239c72da/sensortile_box/hello_world_user/hello_world_user.elf
$repl?=$ORIGIN/hello_world_user.repl

using sysbus
mach create $name

machine LoadPlatformDescription @https://zephyr-dashboard.renode.io/zephyr_sim/769c4f2846db675bc5c584b6d35551ad239c72da/69ac352227821ca8b29c15396709038725064d8a/sensortile_box/hello_world_user/hello_world_user.repl
