...
$name?="qemu_riscv32"
$bin?=@https://zephyr-dashboard.renode.io/zephyr/9463d9a51d9cb1094bf98ef437a39850a7b5705d/qemu_riscv32/micropython/micropython.elf
$repl?=$ORIGIN/micropython.repl

using sysbus
mach create $name

machine LoadPlatformDescription @https://zephyr-dashboard.renode.io/zephyr_sim/9463d9a51d9cb1094bf98ef437a39850a7b5705d/f0b6003e9e203d0c86b802628142a51df66eed1c/qemu_riscv32/micropython/micropython.repl
