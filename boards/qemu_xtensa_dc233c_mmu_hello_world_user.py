...
$bin?=@https://zephyr-dashboard.renode.io/zephyr/5442dabdbbeac2e628f12ca768729cdfca45a76e/qemu_xtensa_dc233c_mmu/hello_world_user/hello_world_user.elf
$repl?=$ORIGIN/hello_world_user.repl

using sysbus
mach create $name

machine LoadPlatformDescription @https://zephyr-dashboard.renode.io/zephyr_sim/5442dabdbbeac2e628f12ca768729cdfca45a76e/d946d6ef3b1b3ea53f9dbd1bd9cb641aa075d6db/qemu_xtensa_dc233c_mmu/hello_world_user/hello_world_user.repl
