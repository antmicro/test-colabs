...
$bin?=@https://zephyr-dashboard.renode.io/zephyr/c5dffcb7c9da611b40a828f79fc6a8405416c1ed/qemu_xtensa_dc233c_mmu/hello_world_user/hello_world_user.elf
$repl?=$ORIGIN/hello_world_user.repl

using sysbus
mach create $name

machine LoadPlatformDescription @https://zephyr-dashboard.renode.io/zephyr_sim/c5dffcb7c9da611b40a828f79fc6a8405416c1ed/ca819552dcd6627e19c44b25cfd1df9dbc17be42/qemu_xtensa_dc233c_mmu/hello_world_user/hello_world_user.repl
