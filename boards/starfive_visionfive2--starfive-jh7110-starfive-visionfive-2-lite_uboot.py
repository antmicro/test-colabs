...
$bin?=@https://zephyr-dashboard.renode.io/uboot/e3405917a1806971d9e72a94186b299f05581e1a/starfive_visionfive2--starfive-jh7110-starfive-visionfive-2-lite/uboot/uboot.elf
$repl?=$ORIGIN/uboot.repl

using sysbus
mach create $name

machine LoadPlatformDescription @https://u-boot-dashboard.renode.io/uboot_sim/e3405917a1806971d9e72a94186b299f05581e1a/f737da4d0af595b97dc46376762a8c876002c508/starfive_visionfive2--starfive-jh7110-starfive-visionfive-2-lite/uboot/uboot.repl
...
"""
    ...
    cpu0 SetRegister "A1" 0x00000000402a4640                # fdt location
