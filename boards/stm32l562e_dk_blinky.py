...
$name?="stm32l562e_dk"
$bin?=@https://zephyr-dashboard.renode.io/zephyr/3deeffb422071c6320b601796cf98e761abd662a/stm32l562e_dk/blinky/blinky.elf
$repl?=$ORIGIN/blinky.repl

using sysbus
mach create $name

machine LoadPlatformDescription @https://zephyr-dashboard.renode.io/zephyr_sim/3deeffb422071c6320b601796cf98e761abd662a/aadba26ac052f0e522abcb035a1b99315f49eda8/stm32l562e_dk/blinky/blinky.repl
