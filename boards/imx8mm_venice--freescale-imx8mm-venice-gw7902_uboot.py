...
$bin?=@https://zephyr-dashboard.renode.io/uboot/922cf29dd8045f7348ce0f20145f46e8235faf21/imx8mm_venice--freescale-imx8mm-venice-gw7902/uboot/uboot.elf
$repl?=$ORIGIN/uboot.repl

using sysbus
mach create $name

machine LoadPlatformDescription @https://u-boot-dashboard.renode.io/uboot_sim/922cf29dd8045f7348ce0f20145f46e8235faf21/dc52b24c118a8a53b59b619636004ce16a57c68e/imx8mm_venice--freescale-imx8mm-venice-gw7902/uboot/uboot.repl
...
"""
    ...
    cpu2 IsHalted true
    cpu3 IsHalted true
    sysbus LoadBinary @https://zephyr-dashboard.renode.io/uboot/922cf29dd8045f7348ce0f20145f46e8235faf21/imx8mm_venice--freescale-imx8mm-venice-gw7902/uboot/uboot.dtb 0x0000000040301060
"""
