...
$name?="sam4l_ek"
$bin?=@https://zephyr-dashboard.renode.io/zephyr/4ebb22e7109a111735a8da769fafbd2543c4511a/sam4l_ek/rust-app/rust-app.elf
$repl?=$ORIGIN/rust-app.repl

using sysbus
mach create $name

machine LoadPlatformDescription @https://zephyr-dashboard.renode.io/zephyr_sim/4ebb22e7109a111735a8da769fafbd2543c4511a/65a66c089ee2cff218924f21bfbd7545fbf72a50/sam4l_ek/rust-app/rust-app.repl
