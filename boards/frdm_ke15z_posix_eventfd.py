...
$name?="frdm_ke15z"
$bin?=@https://zephyr-dashboard.renode.io/zephyr/caa8079a5362cd0437ec4d74c888077857df1a9c/frdm_ke15z/posix_eventfd/posix_eventfd.elf
$repl?=$ORIGIN/posix_eventfd.repl

using sysbus
mach create $name

machine LoadPlatformDescription @https://zephyr-dashboard.renode.io/zephyr_sim/caa8079a5362cd0437ec4d74c888077857df1a9c/5b03e34050deb983d78c70ca46dc94fee6e45f2a/frdm_ke15z/posix_eventfd/posix_eventfd.repl
