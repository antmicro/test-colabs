...
$name?="mr_canhubk3"
$bin?=@https://zephyr-dashboard.renode.io/zephyr/54b826336bae437f851fcba332481e24a7e1532d/mr_canhubk3/philosophers/philosophers.elf
$repl?=$ORIGIN/philosophers.repl

using sysbus
mach create $name

machine LoadPlatformDescription @https://zephyr-dashboard.renode.io/zephyr_sim/54b826336bae437f851fcba332481e24a7e1532d/0e512aebf21a8c51bda51fa67354277811f10a40/mr_canhubk3/philosophers/philosophers.repl
