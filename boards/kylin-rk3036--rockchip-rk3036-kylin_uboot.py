...
$bin?=@https://zephyr-dashboard.renode.io/uboot/ff498a3c5efb424accc1d825cc45cede2540ca13/kylin-rk3036--rockchip-rk3036-kylin/uboot/uboot.elf
$repl?=$ORIGIN/uboot.repl

using sysbus
mach create $name

machine LoadPlatformDescription @https://u-boot-dashboard.renode.io/uboot_sim/ff498a3c5efb424accc1d825cc45cede2540ca13/d228058428cec4d6b66916cf4133bcbab372011b/kylin-rk3036--rockchip-rk3036-kylin/uboot/uboot.repl
...
"""
    ...
    cpu1 IsHalted true
    sysbus LoadBinary @https://zephyr-dashboard.renode.io/uboot/ff498a3c5efb424accc1d825cc45cede2540ca13/kylin-rk3036--rockchip-rk3036-kylin/uboot/uboot.dtb 0x60070a08
"""
