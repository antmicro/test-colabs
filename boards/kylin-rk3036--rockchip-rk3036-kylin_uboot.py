...
$bin?=@https://zephyr-dashboard.renode.io/uboot/780084d7c07f511da4a39b43277c573156ed42e0/kylin-rk3036--rockchip-rk3036-kylin/uboot/uboot.elf
$repl?=$ORIGIN/uboot.repl

using sysbus
mach create $name

machine LoadPlatformDescription @https://u-boot-dashboard.renode.io/uboot_sim/780084d7c07f511da4a39b43277c573156ed42e0/2f38330776ed8394dfffbd33bdbd858255ca7bdd/kylin-rk3036--rockchip-rk3036-kylin/uboot/uboot.repl
...
"""
    ...
    cpu1 IsHalted true
    sysbus LoadBinary @https://zephyr-dashboard.renode.io/uboot/780084d7c07f511da4a39b43277c573156ed42e0/kylin-rk3036--rockchip-rk3036-kylin/uboot/uboot.dtb 0x60071098
"""
