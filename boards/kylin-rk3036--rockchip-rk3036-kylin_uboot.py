...
$bin?=@https://zephyr-dashboard.renode.io/uboot/527115ef6783cec49e5610c523c124b399011361/kylin-rk3036--rockchip-rk3036-kylin/uboot/uboot.elf
$repl?=$ORIGIN/uboot.repl

using sysbus
mach create $name

machine LoadPlatformDescription @https://u-boot-dashboard.renode.io/uboot_sim/527115ef6783cec49e5610c523c124b399011361/1a7a8b98a93b37b4537c0f7810cd17eb2bb55ae4/kylin-rk3036--rockchip-rk3036-kylin/uboot/uboot.repl
...
"""
    ...
    cpu1 IsHalted true
    sysbus LoadBinary @https://zephyr-dashboard.renode.io/uboot/527115ef6783cec49e5610c523c124b399011361/kylin-rk3036--rockchip-rk3036-kylin/uboot/uboot.dtb 0x600712b8
"""
