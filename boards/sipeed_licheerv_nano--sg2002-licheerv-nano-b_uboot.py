...
$bin?=@https://zephyr-dashboard.renode.io/uboot/fd976ff3a233ae7c6a9f5bec790b02bbbf57bb24/sipeed_licheerv_nano--sg2002-licheerv-nano-b/uboot/uboot.elf
$repl?=$ORIGIN/uboot.repl

using sysbus
mach create $name

machine LoadPlatformDescription @https://u-boot-dashboard.renode.io/uboot_sim/fd976ff3a233ae7c6a9f5bec790b02bbbf57bb24/678fb194936e871ab3a4ef84a842f33d5624bad5/sipeed_licheerv_nano--sg2002-licheerv-nano-b/uboot/uboot.repl
...
"""
    ...
    cpu0 SetRegister "A1" 0x000000008025c170                # fdt location
