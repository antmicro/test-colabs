...
$bin?=@https://zephyr-dashboard.renode.io/uboot/f9ffeec4bdcf1da655a0ffea482062adde78fee8/sipeed_licheerv_nano--sg2002-licheerv-nano-b/uboot/uboot.elf
$repl?=$ORIGIN/uboot.repl

using sysbus
mach create $name

machine LoadPlatformDescription @https://u-boot-dashboard.renode.io/uboot_sim/f9ffeec4bdcf1da655a0ffea482062adde78fee8/7f0af423ad652a8a5c6fe5b28d0606e7a294ef55/sipeed_licheerv_nano--sg2002-licheerv-nano-b/uboot/uboot.repl
...
"""
    ...
    cpu0 SetRegister "A1" 0x000000008025cf00                # fdt location
