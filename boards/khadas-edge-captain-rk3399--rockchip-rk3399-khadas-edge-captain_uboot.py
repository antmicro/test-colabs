...
machine LoadPlatformDescription @https://u-boot-dashboard.renode.io/uboot_sim/2ca1398a5ece8d33d8feb6b410e6e38588b5d2bc/327f86675b49497a02301a95de5220ccc7bab67d/khadas-edge-captain-rk3399--rockchip-rk3399-khadas-edge-captain/uboot/uboot.repl
...
macro reset
"""
    sysbus LoadELF @https://zephyr-dashboard.renode.io/uboot/2ca1398a5ece8d33d8feb6b410e6e38588b5d2bc/khadas-edge-captain-rk3399--rockchip-rk3399-khadas-edge-captain/uboot/uboot.elf
    ...
    cpu4 IsHalted true
    cpu5 IsHalted true
    sysbus LoadSymbolsFrom @https://zephyr-dashboard.renode.io/uboot/2ca1398a5ece8d33d8feb6b410e6e38588b5d2bc/khadas-edge-captain-rk3399--rockchip-rk3399-khadas-edge-captain/uboot/uboot.elf textAddress=0x000000000ff1d000
    cpu0 EnableProfilerCollapsedStack $ORIGIN/uboot-profile true 62914560 maximumNestedContexts=10
    sysbus LoadBinary @https://zephyr-dashboard.renode.io/uboot/2ca1398a5ece8d33d8feb6b410e6e38588b5d2bc/khadas-edge-captain-rk3399--rockchip-rk3399-khadas-edge-captain/uboot/uboot.dtb 0x00000000002dcb30
"""
